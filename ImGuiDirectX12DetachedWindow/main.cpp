...
static D3D12_GRAPHICS_PIPELINE_STATE_DESC psoDesc = {};

void SetupImGuiStyle(HWND window);
...
void CreatePipelineStateDescription();
...
int CALLBACK WinMain(
    ...
    HRESULT hrPipelineResult = g_pd3dDevice->CreateGraphicsPipelineState(&psoDesc, IID_ID3D12PipelineState, (void**) &pso);
    if (FAILED(hrPipelineResult))
    {
        CleanupDeviceD3D();
        ::UnregisterClassW(wc.lpszClassName, wc.hInstance);
        return 1;
    ...
    Loader::Initialize(g_pd3dDevice);
    SetupImGuiStyle(hwnd);
...
void SetupImGuiStyle(HWND window)
{
    ...
    colors[ImGuiCol_HeaderHovered] = ImColor(30, 30, 30, 255);
    colors[ImGuiCol_PopupBg] = ImColor(35, 35, 45, 255);
    colors[ImGuiCol_Button] = ImColor(30, 30, 30, 180);
